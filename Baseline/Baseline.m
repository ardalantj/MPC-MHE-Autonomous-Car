...
figure(1)
subplot(311)
plot(t,xx(1,1:end-1),'b','linewidth',2.5); axis([0 t(end) 0 1.8]);hold on
ylabel('x (m)')
grid on
subplot(312)
plot(t,xx(2,1:end-1),'b','linewidth',2.5); axis([0 t(end) 0 1.8]);hold on
ylabel('y (m)')
grid on
subplot(313)
plot(t,xx(3,1:end-1),'b','linewidth',2.5); axis([0 t(end) -pi/4 pi/2]);hold on
xlabel('time (seconds)')
ylabel('\theta (rad)')
grid on
...
grid on
title("Control Term in the Objective (N = 10)")
...
% plot(t,r,'r','linewidth',2.5); axis([0 t(end) -0.2 3]); hold on
% ylabel('Range: [ r (m) ]')
% grid on
% legend('Ground Truth','Measurement')
% subplot(212)
% plot(t,atan(xx(2,1:end-1)./xx(1,1:end-1)),'b','linewidth',2.5); hold on
% plot(t,alpha,'r','linewidth',2.5); axis([0 t(end) 0.2 1]); hold on
...
figure(1)
subplot(311)
plot(t(N_MHE+1:end),X_estimate(:,1),'color','black','linewidth',2.5); hold on
lgd = legend('Ground Truth','Measurement','MHE')
lgd.FontSize = 16
set(gca,'FontSize',20)

subplot(312)
plot(t(N_MHE+1:end),X_estimate(:,2),'color','black','linewidth',2.5); axis([0 t(end) 0 1.8]);hold on
set(gca,'FontSize',20)

subplot(313)
plot(t(N_MHE+1:end),X_estimate(:,3),'color','black','linewidth',2.5); axis([0 t(end) -pi/4 pi/2]);hold on
set(gca,'FontSize',20)
